...
if __name__ == "__main__":
    ...
    final_result.to_csv("./result/xgb_vertical_result.csv", encoding="utf8", index=False, float_format='%.2f')
    score_df.to_csv("./result/xgb_vertical_score.csv", encoding="utf8", index=False, float_format='%.4f')
