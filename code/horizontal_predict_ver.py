...
if __name__ == "__main__":
    ...
    for var in var_col:
        ...
        for wtid in range(1, 34):
            ...
            predict_y, test_score = _model_predict(train_data, predict_data, var, num_boost_round=2500)
    ...
    if lgb_obj == "mape":
        ...
        lgb_obj = ""
    final_result.to_csv("./result/horizontal_result_ver{}.csv".format(lgb_obj), encoding="utf8", index=False, float_format='%.2f')
    score_df.to_csv("./result/horizontal_score_ver{}.csv".format(lgb_obj), encoding="utf8", index=False, float_format='%.4f')
